  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="center">
      ...
      <StarsDecorations display={['none', 'none', 'block']}>
        <img src="/images/Lotto/star-big.png" width="124px" height="109px" alt="" />
        <img src="/images/Lotto/star-small.png" width="70px" height="62px" alt="" />
        <img src="/images/Lotto/three-stars.png" width="130px" height="144px" alt="" />
        <img src="/images/Lotto/ticket-l.png" width="123px" height="83px" alt="" />
        <img src="/images/Lotto/ticket-r.png" width="121px" height="72px" alt="" />
      </StarsDecorations>
      <Heading mb="8px" scale="md" color="#ffffff" id="Lotto-hero-title">
        {t('The PancakeSwap Lotto')}
      </Heading>
      {getHeroHeading()}
      <TicketContainer
        position="relative"
