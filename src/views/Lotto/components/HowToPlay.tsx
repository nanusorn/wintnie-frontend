    ...
    <Box width="100%">
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <Text mb="16px" color="textSubtle">
            {t('Here’s an example Lotto draw, with two tickets, A and B.')}
          </Text>
          <BulletList>
            <li>
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <Text color="textSubtle">{t('The prizes for each Lotto round come from three sources:')}</Text>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'An average total of 35,000 CAKE from the treasury is added to Lotto rounds over the course of a week. This CAKE is of course also included in rollovers! Read more in our guide to ',
                )}
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        <Image width={240} height={172} src="/images/Lotto/tombola.png" alt="tombola bunny" mr="8px" mb="16px" />
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.pancakeswap.finance/products/Lotto/Lotto-guide">
              {t('how to play the PancakeSwap Lotto!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
