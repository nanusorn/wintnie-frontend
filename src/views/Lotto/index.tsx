...
import { useFetchLotto, useLotto } from 'state/Lotto/hooks'
import {
  TITLE_BG,
  GET_TICKETS_BG,
  FINISHED_ROUNDS_BG,
...
import useGetNextLottoEvent from './hooks/useGetNextLottoEvent'
...
const Lotto = () => {
  ...
  const { nextEventTime, postCountdownText, preCountdownText } = useGetNextLottoEvent(endTimeAsInt, status)
